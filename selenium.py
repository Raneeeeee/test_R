...
df2.to_csv(r'C:\ITWILL\공모전\data\품목별수출입실적2022.csv', index=False, sep='\t', encoding='utf-16')

df3 = pd.read_csv(r'C:\ITWILL\공모전\data\품목별수출입실적2022.csv', sep=',', encoding='utf-16')
df3


df3['무역수지'] = df4['무역수지'].astype('float32')
