# -*- coding: utf-8 -*-
"""
Created on Mon May 15 17:42:36 2023
...
for hs in hscode :
    ...
    if len(str(hs))==9 :
        url = f"https://apis.data.go.kr/1220000/Itemtrade/getItemtradeList?serviceKey=4zvIP%2BsjQwMdl1yNBQ3J7lWEUZ9LELXYe9lqSwA%2Fp%2FnO8YILy68BJO6vaSASPmZ6fd85YN9pj%2FLRPxZ5vdPbIg%3D%3D&strtYymm=201701&endYymm=201712&hsSgn=0{hs}"
    else :
        url = f"https://apis.data.go.kr/1220000/Itemtrade/getItemtradeList?serviceKey=4zvIP%2BsjQwMdl1yNBQ3J7lWEUZ9LELXYe9lqSwA%2Fp%2FnO8YILy68BJO6vaSASPmZ6fd85YN9pj%2FLRPxZ5vdPbIg%3D%3D&strtYymm=201701&endYymm=201712&hsSgn={hs}"
...
type(df['hsCode'][0]) # str
type(df['날짜'][0]) # str

df2.to_csv(r'C:\ITWILL\공모전\data\품목별수출입실적2017.csv', index=None,  encoding='cp949')
